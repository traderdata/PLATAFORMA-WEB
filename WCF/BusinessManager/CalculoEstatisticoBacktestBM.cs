...
{
    public class CalculosEstatisticosBacktestBM
    {
        ...
        */
         ...
         * Data: 27/10/2009
         */
        public bool EvaluateCruzamentoDeDuasSMA(List<double> listaValores, int periodoMedia1, int periodoMedia2, double margemErro, string tipo)
        {
        ...
        public bool EvaluateCruzamentoDeDuasEMA(List<double> listaValores, int periodoMedia1, int periodoMedia2, double margemErro, string tipoCruzamento)
        {
            ...
            {
                //quando o metodo nao consegue calcular deve retornar false
                return false;
            }
