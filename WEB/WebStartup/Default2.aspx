<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default2.aspx.cs" Inherits="WebStartup.Default2" %>
...
<!--END Facebook BLOCK-->
    ...
    <div id="silverlightControlHost">
        <object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="100%" height="100%" id="silverlightControl">
		  <param name="source" value="ClientBin/TerminalWeb2.xap"/>
		  <param name="onError" value="onSilverlightError" />
          <param name="onLoad" value="pluginLoaded" />
          <param name="windowless" value="true" />
          <param name="initParams" value="fblogin=false,refid=<%=Request["refid"]%>,distribuidor=<%=ConfigurationSettings.AppSettings["DISTRIBUIDOR"]%>" />
